  ...
  return (
    <div className="form-container">
        <form onSubmit={handleSubmit(onSubmit)}>
            ...
            <select id="manufacturer" {...register("manufacturer", { required: "Manufacturer is required" })}>
            ...
            <select id="model" {...register("model", { required: "Model is required" })}>
            ...
            <input
                ...
                {...register("cylinders", { required: "Cylinders information is required" })}
            />
            {errors.cylinders && <p>{errors.cylinders.message}</p>}

            <label htmlFor="fuel">Fuel:</label>
            <select id="fuel" {...register("fuel", { required: "Fuel type is required" })}>
            ...
            <select id="title_status" {...register("title_status", { required: "Title status is required" })}>
            ...
            <select id="transmission" {...register("transmission", { required: "Transmission type is required" })}>
            ...
            <select id="drive" {...register("drive", { required: "Drive type is required" })}>
            ...
            <select id="paint_color" {...register("paint_color", { required: "Paint color is required" })}>
